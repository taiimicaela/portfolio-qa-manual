...
|:---|:---|:---|:---|:---|
| **CT01** | Login com sucesso | 1. Acessar o site <br> 2. Digitar `standard_user` <br> 3. Digitar `secret_sauce` <br> 4. Clicar em Login | O usuário deve acessar a página de produtos. | ✅ Passou ([Ver Evidência](../evidencias/evidencia-ct01-login-sucesso.png))|
...
| **CT05** | Login com usuário bloqueado | 1. Acessar o site <br> 2. Digitar `locked_out_user` <br> 3. Digitar `secret_sauce` <br> 4. Clicar em Login | Exibir mensagem: "Sorry, this user has been locked out". | ✅ Passou ([Ver Evidência](../evidencias/evidencia-ct05-usuario-bloqueado.png)) |
