...
|:---|:---|:---|:---|:---|
| **CT01** | Login com sucesso | 1. Acessar o site <br> 2. Digitar `standard_user` <br> 3. Digitar `secret_sauce` <br> 4. Clicar em Login | O usuário deve acessar a página de produtos. | ⬜ Pendente |
